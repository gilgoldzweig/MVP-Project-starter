 ...
 */
open class MutableStateLiveData<T> : MutableLiveData<StateData<T>>() {
    ...
    /**
     * Use this to put the Data on a [StateData.DataStatus.CREATED] Status
     */
    fun postCreated() {
        postValue(stateData.created())
    }
